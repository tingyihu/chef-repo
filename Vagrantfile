...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "tingyihu-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/reston_lab"
  #   chef.validation_client_name = "reston_lab-validator"
  #   chef.validation_key_path = ".chef/reston_lab-validator.pem"
  # end
end
